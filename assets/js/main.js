(() => {
  ...
  const updateCarousel = () => {
    ...
    // Op mobiel gebruikt de carrousel native horizontal scrolling en scroll-snap.
    // Daardoor voelt swipen natuurlijker en blijft verticaal scrollen soepel werken.
    if (isMobileCarousel()) {
